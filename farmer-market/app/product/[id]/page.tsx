...
import { getProductById, getProductImage } from "@/app/lib/products";
...
export async function generateMetadata({
  ...
  const description =
    product.description ||
    `${product.category} available from ${product.location} at ₹${product.price}.`;
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: "article",
      images: [{ url: getProductImage(product), alt: product.name }],
    },
    twitter: {
